# Inventory Management CRUD – Python & MySQL 🛒

My first full CRUD application for managing product inventory. Built with Python, MySQL and Tkinter.
...
## How to Run
1. Clone the repo
2. Install requirements: `pip install mysql-connector-python`
